...
export const TICKET_FIELD_CONFIG = Object.freeze([
  ...
  },
  {
    ...
    entity: "ticket",
    required: true,
    options: apiOptions("/service-types?isActive=true"),
    form: { create: true, update: true, detail: true },
  ...
  },
  {
    ...
    entity: "contact",
    required: true,
    options: apiOptions("/districts?isActive=true"),
    form: { create: true, update: true, detail: true },
    grid: { visible: true, width: 150 },
  },
  ...
  },
  {
    ...
    entity: "ticket",
    required: true,
    options: apiOptions("/departments?isActive=true"),
    form: { create: true, update: true, detail: true },
    grid: {
      visible: true,
      width: 190,
  ...
  },
  {
    ...
    entity: "ticket",
    required: true,
    options: apiOptions("/ticket-categories?isActive=true"),
    form: { create: true, update: true, detail: true },
  ...
  },
  {
    ...
    type: "select",
    entity: "ticket",
    options: apiOptions("/problem-statements?isActive=true"),
    form: { create: true, update: true, detail: true },
    grid: { visible: false },
  },
  {
  ...
  },
  {
    ...
    type: "select",
    entity: "ticket",
    options: apiOptions("/current-bill-statuses?isActive=true"),
    form: { create: true, update: true, detail: true },
    grid: { visible: false },
  },
  {
  ...
  },
  {
    ...
    entity: "ticket",
    required: true,
    options: apiOptions("/ticket-statuses?isActive=true"),
    form: { create: true, update: true, detail: true },
  ...
  },
  {
    ...
    type: "select",
    entity: "ticket",
    options: apiOptions("/ticket-severities?isActive=true"),
    form: { create: true, update: true, detail: true },
    grid: { visible: true, width: 130 },
  },
  {
  ...
  },
  {
    ...
    type: "select",
    entity: "ticket",
    options: apiOptions("/ticket-issue-categories?isActive=true"),
    form: { create: true, update: true, detail: true },
  ...
  },
  {
    ...
    type: "select",
    entity: "ticket",
    options: apiOptions("/ticket-dependency-categories?isActive=true"),
    form: { create: true, update: true, detail: true },
    grid: { visible: true, width: 170 },
  },
  {
