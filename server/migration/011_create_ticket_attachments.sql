-- ============================================================================
-- Migration: 011_create_ticket_attachments
-- Purpose  : File attachments uploaded against tickets.
...
CREATE INDEX ticket_attachments_ticket_idx ON ticket_attachments (ticket_id, created_at DESC);
CREATE INDEX ticket_attachments_user_idx   ON ticket_attachments (user_id);
...
FOR EACH ROW EXECUTE FUNCTION set_ticket_attachments_updated_at();
