-- ============================================================================
-- Migration: 010_create_ticket_comments
-- Purpose  : Comments posted on tickets by users.
-- ============================================================================
...
CREATE INDEX ticket_comments_ticket_idx ON ticket_comments (ticket_id, created_at DESC);
CREATE INDEX ticket_comments_user_idx   ON ticket_comments (user_id);
...
FOR EACH ROW EXECUTE FUNCTION set_ticket_comments_updated_at();
