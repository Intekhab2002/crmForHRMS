...
const codeSchema = z
    ...
    .regex(
        /^[A-Z][A-Z0-9_-]*$/,
        "District code must start with an uppercase letter and contain only uppercase letters, numbers, underscores or hyphens.",
    );
...
const districtListQuerySchema = z.object({
...
const updateDistrictSchema = z.object({
    ...
    {
        message:
            "At least one district field must be provided.",
    },
);
