...
const codeSchema = z
    ...
    .regex(
        /^[A-Z][A-Z0-9_-]*$/,
        "Service type code must start with an uppercase letter and contain only uppercase letters, numbers, underscores or hyphens.",
    );
...
const serviceTypeListQuerySchema = z.object({
